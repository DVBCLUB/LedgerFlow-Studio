...
const groups = [
  ...
  ['Robot automation UI panel', 'src/modules/ai-nhan-su/AIWorkforceRobotAutomationBridge.tsx', ['Robot + Automation Bridge', '/api/robot-capabilities', '/api/automation-scheduler/status', 'schedulerAction']],
  ...
  ['AI Workforce UI shell', 'src/modules/ai-nhan-su/AIOperationsCenter.tsx', ['AIWorkforceMissionControl', 'AIWorkforcePatchReviewSessions', 'AIWorkforcePluginSecurityGuard']],
];
