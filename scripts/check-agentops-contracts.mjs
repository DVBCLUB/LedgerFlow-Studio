...
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'Receivable', 'Finance Core must track receivables.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'Payable', 'Finance Core must track payables.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'Advance', 'Finance Core must track advances.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'Settlement', 'Finance Core must track settlements.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'accountingFlow', 'Finance Core must track accounting cash/non-cash flow.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'settlementStatus', 'Finance Core must track settlement status.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'dueDate', 'Finance Core must track due dates.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'documentNo', 'Finance Core must track source document numbers.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'taxNote', 'Finance Core must track tax/VAT/PIT notes.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'receivableOpen', 'Finance Core must show open receivables.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'payableOpen', 'Finance Core must show open payables.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'advanceOpen', 'Finance Core must show open advances.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'overdueItems', 'Finance Core must flag overdue items.');
assertContains('src/components/agent-ops/tabs/FinanceCoreTab.tsx', 'missingDocumentItems', 'Finance Core must flag missing documents.');
