...
const contracts = [
  ...
  },
  {
    ...
    description: 'Create an issue on a configured GitHub repository.',
    permission: 'github:push',
    risk: 'medium',
    requiresApproval: true,
    timeoutMs: 30_000,
  ...
  {
    id: 'github_close_pr',
    description: 'Close a pull request on GitHub with an audit comment.',
    permission: 'github:push',
    risk: 'high',
    requiresApproval: true,
    timeoutMs: 30_000,
  ...
  {
    id: 'github_get_summary',
    description: 'Read repository summary including recent Actions runs, open issues and PRs.',
  ...
  {
    id: 'github_get_run_jobs',
    description: 'Read jobs and failed steps for a GitHub Actions run.',
    permission: 'github:pull',
    risk: 'low',
    requiresApproval: false,
    timeoutMs: 30_000,
  ...
  {
    id: 'github_get_pr_digest',
    description: 'Fetch a safety digest for a GitHub Pull Request (files, review notes).',
    permission: 'github:pull',
    risk: 'medium',
    requiresApproval: false,
    timeoutMs: 30_000,
  ...
  {
    id: 'github_get_artifacts',
    description: 'List and read artifacts for a GitHub Actions run.',
    permission: 'github:pull',
    risk: 'low',
    requiresApproval: false,
    timeoutMs: 30_000,
