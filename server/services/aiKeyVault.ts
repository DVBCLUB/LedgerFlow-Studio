...
const SUPPORTED_PROVIDERS: AIProviderDefinition[] = [
  ...
  },
  {
    ...
    docsUrl: "https://midjourney.com",
    note: "API sinh hình ảnh & Storyboard keyframes chất lượng điện ảnh của Midjourney.",
  },
  {
    id: "flux1",
    label: "Flux.1 (Black Forest Labs)",
    requiresApiKey: true,
    defaultModel: "flux-pro-1.1",
    docsUrl: "https://bfl.ml",
    note: "Mô hình sinh hình ảnh chân thực 4K và chi tiết siêu nét hàng đầu.",
  },
  {
    id: "kling",
    label: "Kling AI 1.5 (Kuaishou)",
    requiresApiKey: true,
    defaultModel: "kling-v1.5",
    docsUrl: "https://klingai.com",
    note: "Mô hình sinh Video AI chuyển động tốc độ cao 1080p 60fps.",
  },
  {
    id: "sora",
    label: "Sora (OpenAI Video)",
    requiresApiKey: true,
    defaultModel: "sora-1.0",
    docsUrl: "https://platform.openai.com/docs/guides/sora",
    note: "Nền tảng tạo video AI chuẩn điện ảnh đa nhân vật của OpenAI.",
  },
  {
    id: "pika",
    label: "Pika Labs 2.0",
    ...
    note: "Sinh video ngắn kèm hiệu ứng đặc biệt và Lip Sync tự động.",
  },
  {
    id: "hailuo",
    label: "Hailuo AI (Minimax)",
    requiresApiKey: true,
    defaultModel: "hailuo-video-v1",
    docsUrl: "https://minimax.chat",
    note: "Mô hình sinh video diễn xuất khuôn mặt tự nhiên.",
  },
  {
    id: "runway",
