  ...
  return (
    <section className="space-y-4 text-slate-100">
      <div className="rounded-3xl border border-slate-800 bg-slate-950/80 p-6">
        ...
        <h2 className="mt-2 text-xl font-black text-white">Checklist sẵn sàng bán sản phẩm số</h2>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5"><p className="text-[10px] font-black uppercase text-slate-500">Readiness score</p><p className="mt-2 text-3xl font-black text-white">{summary.score}/100</p></div>
      ...
      <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-5">
        <div className="grid gap-3 md:grid-cols-[1fr_auto] md:items-end">
          <div>
            ...
            <select value={paymentPath} onChange={(event) => updatePaymentPath(event.target.value as PaymentPath)} className="mt-2 w-full rounded-xl border border-slate-800 bg-slate-950 px-3 py-3 text-sm font-bold text-white">
