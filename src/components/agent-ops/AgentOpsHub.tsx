...
import KnowledgeBaseTab from '../../modules/knowledge-library/KnowledgeBaseTab';
...
import CompanyOSControlPlaneTab from './tabs/CompanyOSControlPlaneTab';
...
function renderTab(tab: AgentOpsHubTab | string) {
  ...
  if (tab === 'controlPlane') return <CompanyOSControlPlaneTab />;
