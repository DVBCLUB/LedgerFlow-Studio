...
const SKILL_KEY = 'ledgerflow_agent_skill_registry_v1';
...
export default function SkillsTab() {
  ...
  return (
    <section className="rounded-3xl border border-indigo-400/35 bg-indigo-400/10 p-4 text-slate-100">
      ...
      <p className="mt-1 text-sm font-semibold leading-6 text-slate-400">Giữ registry skill là tab riêng nhưng dùng type chung AgentSkill.</p>
