...
export const INTERNAL_AUDIT_17_CYCLES: AuditProgramTemplate[] = [
  {
    ...
    redFlags: ['Chi tiền nhiều lần dưới ngưỡng phê duyệt', 'Một người vừa đề nghị vừa duyệt vừa nhận tiền', 'Khoản chi không gắn mã bộ phận/dự án sản phẩm'],
    severity: 'critical'
  },
  {
    id: 'purchasing-ap',
    cycle: 'Mua sắm tài nguyên số và phải trả',
    objective: 'Kiểm soát mua license asset, cloud server, API tokens đúng nhu cầu, đúng giá và không thanh toán trùng.',
    scope: ['Đề nghị mua asset/token', 'Báo giá', 'Hợp đồng/License', 'Biên bản bàn giao số', 'Hóa đơn điện tử', 'Đề nghị thanh toán'],
    procedures: ['So khớp 3 bên Hợp đồng - Bàn giao số - Hóa đơn', 'Tìm số hóa đơn trùng', 'Tìm cùng số tiền cùng NCC trong 7 ngày', 'Kiểm tra thay đổi tài khoản ngân hàng NCC'],
    evidence: ['Bảng matching 3-way', 'Danh sách ngoại lệ', 'Log phê duyệt', 'Biên bản xác nhận NCC'],
    redFlags: ['Hóa đơn về trước khi nhận bàn giao', 'NCC mới phát sinh nhiều giao dịch lớn', 'Thanh toán thiếu biên bản bàn giao license'],
    severity: 'critical'
  },
  {
    id: 'digital-assets-inventory',
    cycle: 'Kho tài nguyên số & Game Assets',
    objective: 'Đảm bảo kho asset 3D, âm thanh, video có thật, quản lý version đúng kỳ, định giá đúng và không thất lạc.',
    scope: ['Phiếu nhập asset', 'Phiếu cấp phát', 'Asset Registry', 'Biên bản kiểm kê số', 'Bảng tính giá vốn asset'],
    procedures: ['So sánh kho asset thực tế với registry', 'Lọc model 3D lỗi polygon/texture', 'Kiểm tra cấp phát asset cho dự án', 'Đánh giá asset chậm sử dụng'],
    evidence: ['Biên bản kiểm kê', 'Danh sách lệch kho', 'Asset preview snapshots', 'Bảng tính giá vốn'],
    redFlags: ['Thất lạc file asset', 'Điều chỉnh kho asset không có lý do', 'Asset trùng lặp không có version tag'],
    severity: 'high'
  },
  {
    id: 'sales-ar',
  ...
  {
    id: 'product-studio-project-cost',
    cycle: 'Chi phí sản phẩm & Studio Game/Video',
    objective: 'Đảm bảo chi phí phân bổ đúng dự án phần mềm/game/video, đúng ngân sách, có nghiệm thu/chứng từ và kiểm soát tạm ứng.',
    scope: ['Dự toán dự án', 'Mã dự án sản phẩm', 'Tài nguyên 3D/Cloud tiêu thụ', 'Chi phí outsource/freelancer', 'Tạm ứng/hoàn ứng'],
    procedures: ['So sánh chi phí thực tế với ngân sách dự án', 'Lọc chi phí không có mã dự án', 'Kiểm tra tạm ứng quá hạn', 'Đối chiếu nghiệm thu sprint với thanh toán'],
    evidence: ['Bảng cost-to-budget', 'Danh sách tạm ứng treo', 'Hồ sơ nghiệm thu sprint', 'Đề nghị thanh toán'],
    redFlags: ['Chi vượt ngân sách dự án chưa phê duyệt', 'Ứng mới khi ứng cũ chưa hoàn', 'Chi phí outsource thiếu nghiệm thu nhưng đã thanh toán'],
    severity: 'critical'
  }
];
