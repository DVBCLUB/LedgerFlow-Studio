...
export const CONSTRUCTION_ACCOUNTING_DOMAINS = [
  ...
  { domain: 'Dự án Studio & Game', scope: 'Dự án game 3D/video, dự toán, tài nguyên số, outsource, nghiệm thu, tạm ứng, chi phí theo dự án.', mustHave: ['mã dự án Studio', 'dự toán', 'tài nguyên 3D/Audio', 'outsource', 'nghiệm thu', 'tạm ứng', 'chi phí dở dang'] },
...
export const COST_TYPE_KNOWLEDGE = [
  ...
  { type: 'Dự án Studio & Game', examples: 'license 3D, server GPU, token API, âm thanh WebAudio, outsource, chi phí chung dự án', documents: ['dự toán', 'hợp đồng', 'bàn giao số', 'nghiệm thu sprint', 'hóa đơn điện tử', 'hồ sơ thanh toán'], risks: ['vượt dự toán', 'thiếu nghiệm thu', 'chi phí treo lâu', 'tạm ứng quá hạn'], kpis: ['budget used %', 'project margin', 'advance aging'] },
...
export const DOCUMENT_CHECKLIST_RULES = [
  ...
  { scenario: 'Chi phí Studio & Dự án Game', minimumDocs: ['dự toán/hợp đồng', 'đề nghị thanh toán', 'phiếu kho hoặc nghiệm thu', 'hóa đơn/chứng từ', 'phê duyệt'], redFlags: ['thanh toán vượt dự toán', 'thiếu nghiệm thu', 'không gắn mã dự án'] },
...
export const ADVANCED_CONSTRUCTION_CASES = [
  { title: 'Thương mại số: nhập license bán lại nhưng kho asset lệch', situation: 'Hóa đơn có 100 license game, kho nhận 96, bán ra 20 trước khi đối chiếu.', accountingFocus: ['giá vốn', 'kho tài nguyên số', 'công nợ NCC', 'biên bản thiếu license'], controlQuestions: ['có biên bản bàn giao số không?', 'ghi nhận thiếu license thế nào?', 'có khóa bán khi chưa nhập kho chuẩn không?'] },
  { title: 'Studio Game: định mức tài nguyên 3D lệch thực tế', situation: 'Định mức 1 màn chơi game dùng 10 asset 3D nhưng thực tế phát sinh 15 asset, chi phí tăng cao.', accountingFocus: ['BOM Game Assets', 'Chi phí dở dang', 'Tối ưu polygon', 'Cost variance'], controlQuestions: ['lệch do thay đổi thiết kế hay thiếu kế hoạch?', 'có cập nhật định mức asset không?', 'giá thành sản phẩm có bị đội lên không?'] },
  ...
  { title: 'Studio Phim AI: tạm ứng sản xuất video 4K quá hạn', situation: 'Trưởng nhóm video ứng tiền thuê GPU/Voice, quá hạn hoàn ứng, chứng từ thiếu hóa đơn điện tử.', accountingFocus: ['tạm ứng', 'hoàn ứng', 'chi phí dự án video', 'chứng từ yếu'], controlQuestions: ['còn treo bao nhiêu?', 'có ứng mới không?', 'phân loại rủi ro đỏ/vàng/xanh?'] },
...
export const FINANCIAL_ACCOUNTING_BLUEPRINT = [
  { area: 'Khung học kế toán đa ngành', add: ['Thương mại số: mua-bán-kho asset-công nợ-biên lợi nhuận', 'Sản xuất công nghệ: BOM Game-định mức asset-WIP-thành phẩm-giá thành', 'Dịch vụ: hợp đồng-timesheet-nghiệm thu-doanh thu theo kỳ', 'Dự án Studio: dự toán-dự án game/video-nghiệm thu-tạm ứng-chi phí dở dang'] },
