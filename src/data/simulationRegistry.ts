...
export const SIMULATION_REGISTRY: SimulationRegistryItem[] = [
  ...
  { id: 'marketing_growth_v2', title: 'Marketing Growth V2 Workspace', component: 'MarketingGrowthV2Workspace', category: 'Marketing', route: '/marketing_growth_v2', offlineMode: 'full', notes: 'Spec-driven marketing workspace for landing copy, email sequence, PLG conversion and unified marketing command center.' },
