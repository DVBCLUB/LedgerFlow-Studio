export const DATA_ENGINEERING_LAYERS = [
  ...
  { title: '2. Làm sạch', detail: 'Chuẩn hóa ngày, tiền VNĐ, mã dự án phần mềm/game, mã đối tác, chi phí cloud và trạng thái hồ sơ.' },
  { title: '3. Mô hình dữ liệu', detail: 'Tách master data và fact data: dự án game/video, đối tác, tài nguyên số, AI nhân sự, chi phí cloud, doanh thu số.' },
...
export const DATA_SCIENCE_USE_CASES = [
  { name: 'Dự báo vượt ngân sách', input: 'Budget, actual cost, phase, change orders', output: 'Khả năng vượt ngân sách theo dự án', method: 'Regression / scenario simulation' },
  ...
  { name: 'Kiểm soát quỹ dầu', input: 'GPU compute hours, token usage, render resolution, quota', output: 'Cảnh báo cấp dầu vượt định mức', method: 'Variance analysis' },
...
export const DATA_QUALITY_RULES = [
  { rule: 'Không để trống mã dự án', reason: 'Chi phí không có mã dự án sẽ không lên được báo cáo studio.' },
...
export const FEATURE_ENGINEERING_RECIPES = [
  ...
  { feature: 'cloud_gpu_variance', formula: 'consumedTokens - allocatedTokenBudget', use: 'Phát hiện rủi ro quỹ dầu.' }
];

export const LEARNING_CHECKLIST = [
  'Hiểu khác nhau giữa dữ liệu thô, dữ liệu sạch, dữ liệu báo cáo và dữ liệu mô hình AI.',
  'Biết thiết kế bảng fact/dimension cho chi phí dự án Studio.',
