...
const factoryPipeline = [
  ...
  ['Provider Routing', 'Ưu tiên nguồn chính thức; khi nguồn xử lý tạm đầy thì chuyển sang profile đã cấu hình hợp lệ.'],
...
const routes = [
  ...
  ['Connector Profiles', 'Các profile connector được founder bật, có log nguồn và giới hạn hành động.', 'controlled'],
  ['IDE Capacity Pool', 'Cursor, Claude Code, Antigravity, VS Code extension và Google AI Studio.', 'dev'],
  ['Capacity Balancer', 'Nếu nguồn A tạm đầy, chuyển sang nguồn B/C đã cấu hình; nếu không còn nguồn thì đưa vào Approval Inbox.', 'safe'],
];
