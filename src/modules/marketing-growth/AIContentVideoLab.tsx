            ...
            {activeIdea && (
              <div className="rounded-xl border border-pink-500/20 bg-pink-950/10 p-3 flex items-center justify-between gap-3 text-xs">
                <div className="flex-1">
                  ...
                  <div className="text-white font-bold truncate mt-0.5">{activeIdea.title}</div>
                  <div className="text-slate-400 text-[10px] truncate mt-0.5">{activeIdea.nicheAudience}</div>
                </div>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-1.5 bg-pink-600 hover:bg-pink-500 text-white rounded-lg font-bold shrink-0 shadow text-[10px] cursor-pointer transition-all"
                >
                  Nạp ý tưởng
                </button>
              </div>
                  ...
                  {repurposeTab === "tiktok" && (
                    <div className="p-3 bg-slate-950/80 rounded-xl border border-slate-900 space-y-2 text-xs">
                      <div>
                        ...
                        <ul className="space-y-1 pl-3 text-slate-300 font-semibold list-disc">
                      ...
                      <div className="pt-1.5 border-t border-slate-900">
                        ...
                        <p className="text-slate-400 text-[10px] font-semibold italic">🗣️ Sử dụng giọng đọc AI nam trầm ấm hoặc tự ghi âm, đi kèm nhạc nền &quot;Tech House Beats&quot; hoặc &quot;Lofi Chill Upbeat&quot; nhịp độ 120BPM.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {repurposeTab === "youtube" && (
                    <div className="p-3 bg-slate-950/80 rounded-xl border border-slate-900 space-y-3.5 text-xs select-text animate-fade-in">
                      <div>
                        ...
                        <div className="space-y-1.5 font-bold text-white">
                          <p className="p-1.5 bg-slate-900 rounded border border-slate-850">1. Cách tôi tự động hóa &quot;{topic}&quot; chỉ với chi phí 0đ!</p>
                          <p className="p-1.5 bg-slate-900 rounded border border-slate-850">2. Hướng dẫn xây dựng &quot;{activeIdea?.title || topic}&quot; chi tiết cho Solo Founder</p>
                          <p className="p-1.5 bg-slate-900 rounded border border-slate-850">3. 3 Bước đóng gói &quot;{activeIdea?.title || topic}&quot; đánh thị trường ngách Việt Nam</p>
                        </div>
                      </div>
                      <div className="pt-2 border-t border-slate-900">
                        <div className="text-[9px] text-cyan-400 font-black uppercase mb-1">Mô tả chi tiết chuẩn hóa (Copy chèn link)</div>
                        <pre className="p-2 bg-slate-900 border border-slate-850 rounded-lg text-[10px] font-mono text-slate-300 whitespace-pre-wrap leading-relaxed max-h-[120px] overflow-y-auto">
...
#solofounder #vietqr #indiedev #microSaaS #${platform}`}
                      ...
                      <div className="pt-2 border-t border-slate-900">
                        ...
                        <p className="text-slate-400 text-[10px] font-mono">{topic.replace(/\s+/g, ", ")}, solo founder, code game 2d, lap trinh vietqr, ledgerflow, app tiet kiem, marketing du kich</p>
                      </div>
                    </div>
                  )}
                  ...
                  {repurposeTab === "facebook" && (
                    <div className="p-3 bg-slate-950/80 rounded-xl border border-slate-900 space-y-2.5 text-xs select-text animate-fade-in">
                      <div>
                        ...
                        <pre className="p-2.5 bg-slate-900 border border-slate-850 rounded-lg text-[10.5px] font-sans text-slate-300 whitespace-pre-wrap leading-relaxed">
                ...
                <div key={agentPrompt.id} className="p-3 bg-slate-950/80 rounded-xl border border-slate-900 flex flex-col justify-between gap-3">
                  <div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-black text-white">{agentPrompt.title}</span>
                      <span className="text-[9px] text-slate-500 font-bold font-mono">{agentPrompt.desc}</span>
                    </div>
                    <p className="text-[10px] text-slate-400 mt-2 font-mono leading-relaxed bg-slate-900/50 p-2 rounded-lg border border-slate-850 select-text max-h-[80px] overflow-y-auto whitespace-pre-wrap">
                      {agentPrompt.prompt}
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-2.5 py-1.5 border border-slate-800 hover:border-slate-700 rounded-lg text-[10px] font-bold text-slate-400 hover:text-white transition cursor-pointer"
                    >
                      Sao chép
                    </button>
                    <button
                      ...
                      className="flex-1 px-3 py-1.5 bg-purple-600 hover:bg-purple-500 text-white rounded-lg text-[10px] font-extrabold uppercase tracking-wider transition text-center cursor-pointer"
                    >
                      Gửi sang AI Agent 🚀
                    </button>
                  </div>
