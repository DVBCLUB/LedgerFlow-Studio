...
import { 
  Search, Sparkles, Copy, Download, Check, Calculator, TrendingUp, Badge, FileText, ArrowRight, Zap, Globe, AlertCircle, HelpCircle, TrendingDown, ExternalLink, ChevronDown, Plus } from 'lucide-react';
import { 
  ResponsiveContainer, 
  AreaChart, 
  Area, 
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-900 pb-5">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-text-tertiary font-bold font-mono">GOOGLE CORE-SEO v1.0</span>
          </div>
        ...
        <button
          ...
          className={`px-3 py-2 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-2 cursor-pointer ${
            activeTab === 'discovery' 
              ...
              : 'text-slate-450 hover:text-slate-200 hover:bg-bg-primary'
          }`}
        >
        ...
        <div className="space-y-6">
          <div className="bg-[#070b13]/80 p-5 rounded-2xl border border-slate-900 space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                <label className="text-[10px] text-text-tertiary font-mono font-bold block mb-1">CHỦ ĐỀ/NGÀNH NGHỀ MỤC TIÊU</label>
                <input
                  type="text"
                  value={nicheInput}
              ...
              <div>
                <label className="text-[10px] text-text-tertiary font-mono font-bold block mb-1 font-mono">ĐỐI TƯỢNG BAN ĐẦU</label>
                <select
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  <label className="text-[10px] text-text-tertiary font-mono font-bold">GIÁ PHẦN MỀM THÁNG TARGET</label>
                ...
                <input
                  ...
                  className="w-full accent-purple-500 h-1 rounded bg-bg-primary cursor-pointer"
                />
              </div>
            </div>
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button
                ...
                className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-text-primary font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all cursor-pointer flex items-center gap-2 shadow-lg disabled:opacity-50"
              >
                {loadingDiscovery ? (
                  <>
                    <svg className="w-4 h-4 animate-spin text-text-primary" fill="none" viewBox="0 0 24 24">
          ...
          {discoveredKeywords.length > 0 ? (
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-slate-950/65 p-3 rounded-xl border border-slate-900">
                ...
                <div className="flex items-center gap-2 shrink-0 flex-wrap">
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`px-2 py-1 text-[10px] font-bold rounded cursor-pointer ${
                          sortField === opt.id ? 'bg-bg-primary text-purple-400' : 'text-text-tertiary'
                        }`}
                      >
                        {opt.label}
                      </button>
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-bg-primary hover:bg-bg-surface border border-border-primary text-emerald-400 font-bold text-[10.5px] rounded-lg transition-all cursor-pointer flex items-center gap-1"
                  >
              ...
              <div className="overflow-x-auto rounded-2xl border border-slate-900 bg-slate-950/20 shadow-lg">
                <table className="w-full text-left text-xs text-text-secondary">
                  <thead className="bg-[#070b13] text-[9.5px] text-text-tertiary uppercase font-mono border-b border-slate-900">
                    <tr>
                    ...
                    {getSortedAndFilteredKeywords().map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3.5 px-4 font-bold text-text-primary max-w-[200px]">
                            <div className="space-y-1">
                              <span className="block truncate" title={item.keyword}>{item.keyword}</span>
                              <div className="flex gap-1 flex-wrap">
                                {item.longtailVariants?.slice(0, 2).map((v, vidx) => (
                                  <span key={vidx} className="bg-slate-950 text-text-tertiary text-[8.5px] px-1.5 py-0.5 rounded border border-slate-900 font-mono">
                                    {v}
                                  </span>
                                ))}
                              </div>
                          ...
                          <td className="py-3.5 px-4 text-center">
                            <span className={`px-2 py-0.5 rounded text-[9px] font-mono font-black uppercase ${
                              ...
                              'bg-slate-950 text-text-secondary border border-slate-900'
                            }`}>
                              {item.intent}
                            </span>
                          </td>
                          ...
                          <td className="py-3.5 px-4 text-center font-mono font-black">
                            ...
                            <span className="text-[8px] text-text-tertiary uppercase tracking-widest block mt-0.5">Khả thi</span>
                          </td>
                          <td className="py-3.5 px-4 text-right">
                            <button
                              ...
                              className={`px-2.5 py-1.5 rounded-lg text-[10.5px] font-black cursor-pointer transition-all border ${
                                isSelected 
                                  ? 'bg-purple-600 border-purple-500 text-text-primary shadow-md' 
                                  : 'bg-slate-950 hover:bg-bg-primary border-slate-900 hover:border-border-primary text-text-secondary'
                              }`}
                            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-slate-950/30 p-4 rounded-xl border border-slate-900">
                <span className="text-[11px] text-text-secondary font-semibold italic text-center md:text-left">
            ...
            <div className="bg-slate-950/5 p-12 rounded-2xl border border-slate-900/60 text-center space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold text-text-secondary">Chưa bắt đầu cào từ khóa nào</p>
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          {blueprintResult ? (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-[#070b13]/85 p-5.5 rounded-xl border border-slate-900 space-y-4">
                  <span className="text-[10px] text-text-tertiary font-black tracking-widest uppercase font-mono block border-b border-slate-900 pb-2">
                  ...
                  <div className="space-y-4">
                    {blueprintResult.coreFeatures.map((feat, idx) => (
                      <div key={idx} className="flex gap-2.5 items-start">
                        ...
                        <p className="text-text-secondary text-xs font-semibold leading-relaxed">{feat}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-[#070b13]/85 p-5.5 rounded-xl border border-slate-900 space-y-4">
                  ...
                  <div className="space-y-3.5 text-xs text-slate-350">
                    <div className="space-y-1">
                      <span className="text-text-tertiary font-mono text-[9px] block">UI FRONTEND RÚT GỌN</span>
                      <p className="font-bold text-text-primary text-xs">{blueprintResult.techStack.frontend}</p>
                    </div>
                    <div className="space-y-1">
                      <span className="text-text-tertiary font-mono text-[9px] block">BACKEND &amp; LOCAL STORAGE</span>
                      <p className="font-bold text-purple-400 text-xs">{blueprintResult.techStack.backend}</p>
                    </div>
                    <div className="space-y-1">
                      <span className="text-text-tertiary font-mono text-[9px] block">MÁY CHỦ HOSTING</span>
                ...
                <div className="bg-[#070b13]/85 p-5.5 rounded-xl border border-slate-900 space-y-4">
                  ...
                  <div className="space-y-3 text-xs">
                    <div className="space-y-1">
                      <span className="text-text-tertiary font-mono text-[9px] block">TỪ KHÓA ĐẦU PHỄU</span>
                    ...
                    <div className="space-y-1">
                      <span className="text-text-tertiary font-mono text-[9px] block">SEO H1 HEADING</span>
                      <p className="font-bold text-text-secondary leading-snug">{blueprintResult.keywordMapping.landingPageTitle}</p>
                    </div>
                    <div className="space-y-1">
                      <span className="text-text-tertiary font-mono text-[9px] block">META DESCRIPTION (CTR BOOST)</span>
                      <p className="text-text-secondary leading-snug text-[10.5px] italic">&ldquo; {blueprintResult.keywordMapping.metaDescription} &rdquo;</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {blueprintResult.pricingTiers.map((tier, tidx) => (
                    <div key={tidx} className="bg-slate-950/80 p-4.5 rounded-xl border border-slate-900 space-y-3 last:border-purple-900/50">
                      <div className="flex justify-between items-center">
                        <span className="text-[11px] font-mono font-extrabold uppercase text-text-secondary">{tier.name}</span>
                      ...
                      <div className="py-2">
                        <span className="text-2xl font-black text-text-primary">{tier.price.toLocaleString('vi-VN')}</span>
                        <span className="text-[10px] text-text-tertiary font-semibold ml-1">đ {tidx === 0 ? '' : tidx === 2 ? '/Năm' : '/Tháng'}</span>
                      </div>
                      <div className="space-y-1.5 pt-2 border-t border-slate-900 text-xs">
                        {tier.features.map((f, fidx) => (
                          <div key={fidx} className="flex gap-2 items-center text-text-secondary">
                ...
                <div className="lg:col-span-5 bg-[#070b13]/85 p-5 rounded-2xl border border-slate-900 space-y-4">
                  ...
                  <div className="space-y-3 text-xs leading-relaxed">
                    <div className="bg-slate-950 p-3 rounded-lg border border-slate-900">
                      ...
                      <ul className="list-disc pl-4 space-y-1 text-text-secondary font-medium">
                    ...
                    <div className="bg-slate-950 p-3 rounded-lg border border-slate-900 space-y-1">
                      ...
                      <p className="text-text-secondary font-medium leading-relaxed">{blueprintResult.day1LaunchPlan}</p>
                    </div>
                    ...
                    <div className="bg-purple-950/10 p-3 rounded-lg border border-purple-900/25 space-y-1">
                      ...
                      <ol className="list-decimal pl-4 text-text-secondary space-y-1 font-medium">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-950 p-4 rounded-xl border border-slate-900">
                <div className="space-y-1">
                  ...
                  <p className="text-[10.5px] text-text-tertiary italic">May đo trang đích SEO Ready bóc tách trực tuyến HOẶC Đưa trực tiếp vào Phân Hệ Quản lý để lập lịch.</p>
                </div>
                ...
                <div className="flex gap-2 flex-wrap w-full sm:w-auto justify-end">
                  <button
                    ...
                    disabled={savedToHub}
                    className="px-4 py-2 bg-bg-primary hover:bg-slate-850 border border-border-primary text-purple-450 hover:text-purple-400 font-extrabold text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-505 text-text-primary font-black text-xs uppercase tracking-wider rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shadow-lg"
                  >
            ...
            <div className="bg-slate-950/5 p-12 rounded-2xl border border-slate-900/60 text-center space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold text-text-secondary">Chưa sinh bản thiết kế sản phẩm súc tích</p>
                <p className="text-xs text-text-tertiary max-w-lg mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#070b13]/85 p-5 rounded-2xl border border-slate-900 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="text-[10px] text-text-tertiary font-mono font-bold block mb-1">TÊN SẢN PHẨM PHẦN MỀM</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-text-tertiary font-mono font-bold block mb-1 font-mono">TỪ KHÓA CHÍNH (PRIMARY SEO KEYWORD)</label>
                <input
                  type="text"
            ...
            <div className="flex justify-end gap-3 pt-1">
              <button
                ...
                className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-text-primary font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all cursor-pointer flex items-center gap-2 disabled:opacity-50"
              >
                {loadingLanding ? (
                  <>
                    <svg className="w-4 h-4 animate-spin text-text-primary" fill="none" viewBox="0 0 24 24">
          ...
          {landingDesign ? (
            <div className="grid lg:grid-cols-12 gap-8 select-text">
              ...
              <div className="lg:col-span-7 bg-slate-950 p-6 rounded-2xl border border-slate-900 container-fluid space-y-12">
                <div className="flex justify-between items-center border-b border-slate-900 pb-3">
                  <span className="text-[10px] text-text-tertiary font-mono font-bold uppercase tracking-wider">🖥️ BẢN PREVIEW TRANG ĐÍCH THỰC TẾ (Rendered View)</span>
                ...
                <div className="space-y-8 max-w-2xl mx-auto text-center py-6">
                  ...
                  <p className="text-text-secondary font-semibold text-sm leading-relaxed max-w-lg mx-auto">
                    {landingDesign.hero.subheadline}
                  </p>

                  <div className="p-1 inline-block bg-bg-primary rounded-xl">
                    <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-text-primary font-black text-sm uppercase rounded-lg shadow-lg">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    {landingDesign.painSection.pains.map((pain, pidx) => (
                      <div key={pidx} className="bg-[#070b13] p-4 rounded-xl border border-rose-950/20 space-y-2">
                        ...
                        <p className="text-text-secondary text-[11px] font-semibold leading-relaxed">{pain}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    {landingDesign.featuresSection.features.map((feat, fidx) => (
                      <div key={fidx} className="bg-[#070b13] p-4 rounded-xl border border-slate-900 space-y-2.5">
                        ...
                        <p className="text-text-secondary text-[11.5px] font-medium leading-relaxed">{feat.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-5 py-6 border-t border-slate-900">
                  <h3 className="text-sm uppercase tracking-wide text-text-tertiary font-mono font-bold text-center">Người dùng thật nói gì?</h3>
                  <div className="grid sm:grid-cols-2 gap-4">
                    {landingDesign.socialProof.testimonials.map((t, idx) => (
                      <div key={idx} className="bg-[#070b13]/55 p-4 rounded-lg border border-slate-900 space-y-3 relative">
                        ...
                        <p className="text-text-secondary text-[11px] italic font-semibold leading-relaxed relative z-10">{t.quote}</p>
                        <div className="pt-2 border-t border-slate-900 text-[10.5px]">
                          <span className="font-black text-text-primary block">{t.name}</span>
                          <span className="text-text-tertiary font-semibold">{t.role}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {/* FAQ Section */}
                <div className="space-y-5 py-6 border-t border-slate-900">
                  <h3 className="text-xs uppercase tracking-wide text-text-tertiary font-mono font-bold text-center">Câu Hỏi Thường Gặp</h3>
                  <div className="space-y-3.5 max-w-xl mx-auto">
                    {landingDesign.faqSection.questions.map((faq, idx) => (
                      <div key={idx} className="bg-[#070b13]/40 p-3 rounded-lg space-y-1 text-xs">
                        <span className="font-extrabold text-text-primary">Q: {faq.q}</span>
                        <span className="block text-text-secondary font-medium leading-relaxed pl-3 border-l border-purple-900/30">A: {faq.a}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-[#070b13]/70 rounded-2xl border border-slate-900 divide-y divide-slate-900 overflow-hidden">
                  ...
                  <div className="space-y-1">
                    <button
                      ...
                      className="w-full text-left p-3.5 text-xs font-bold text-slate-350 flex justify-between items-center hover:bg-bg-primary/20 cursor-pointer"
                    >
                    ...
                    {activeAccordion === 'seo' && (
                      <div className="p-3.5 bg-slate-950/80 space-y-3.5 text-xs border-t border-slate-900">
                        <div className="space-y-1">
                          ...
                          <p className="p-2 bg-slate-950 border border-slate-900 rounded font-semibold text-text-primary font-mono">{landingDesign.seo.title}</p>
                        </div>
                        <div className="space-y-1">
                          <div className="flex justify-between items-center text-[9px] text-text-tertiary">
                          ...
                          <p className="p-2 bg-slate-950 border border-slate-900 rounded text-text-secondary leading-normal font-medium">{landingDesign.seo.metaDescription}</p>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    {activeAccordion === 'hero' && (
                      <div className="p-3.5 bg-slate-950/80 space-y-3.5 text-xs border-t border-slate-900">
                        <div className="space-y-1">
                          ...
                          <p className="p-2 bg-slate-950 border border-slate-900 rounded font-black text-text-primary">{landingDesign.hero.headline}</p>
                        </div>
                        <div className="space-y-1">
                          <div className="flex justify-between items-center text-[9px] text-text-tertiary">
                          ...
                          <p className="p-2 bg-slate-950 border border-slate-900 rounded text-text-secondary font-medium leading-relaxed">{landingDesign.hero.subheadline}</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-1">
                    <button
                      ...
                      className="w-full text-left p-3.5 text-xs font-bold text-text-secondary flex justify-between items-center hover:bg-bg-primary/20 cursor-pointer"
                    >
                      <span className="flex items-center gap-1.5">
                        ...
                        <div className="space-y-3.5 pt-1">
                          {landingDesign.faqSection.questions.map((faq, idx) => (
                            <div key={idx} className="space-y-1.5">
                              ...
                              <span className="block p-2 bg-[#020617] rounded text-text-secondary font-medium leading-relaxed">A: {faq.a}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                  ...
                  <div className="space-y-3 text-xs font-semibold leading-relaxed">
                    {landingDesign.blogIdeas.map((idea, idx) => (
                      <div key={idx} className="flex gap-2 items-start text-text-secondary">
                        ...
                        <div>
                          <p className="font-bold text-text-primary leading-normal">&ldquo; {idea} &rdquo;</p>
                          <span className="text-[10px] text-text-tertiary italic font-medium block mt-1">Từ khóa nhúng: &ldquo;{primaryKeywordInput}&rdquo;</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="bg-slate-950/10 p-12 rounded-2xl border border-slate-900/60 text-center space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold text-text-secondary">Chưa sinh nội dung trang đích SEO</p>
                <p className="text-xs text-text-tertiary max-w-lg mx-auto">
              ...
              <div className="space-y-4 text-xs font-semibold">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-text-secondary font-bold block flex items-center gap-1">1. LƯU LƯỢNG GOOGLE TRAFFIC</span>
                  ...
                  />
                  <span className="text-[10px] text-text-tertiary italic leading-snug font-medium block">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-text-secondary font-bold block flex items-center gap-1">2. TỶ LỆ CLICK ORGANIC (CTR)</span>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-text-secondary font-bold block flex items-center gap-1">3. TỶ LỆ DÙNG THỰC -&rsaquo; PRO</span>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-text-secondary font-bold block flex items-center gap-1">4. ĐỊNH GIÁ / THÁNG (VND)</span>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-text-secondary font-bold block flex items-center gap-1">5. TỶ LỆ HỦY GÓI (CHURN RATE)</span>
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-[#070b13]/85 p-4 rounded-xl border border-slate-900">
                  <span className="text-text-tertiary text-[10px] uppercase font-bold tracking-wider">REALISTIC Month 12 MRR</span>
                  <p className="text-xl font-black mt-1 mb-0.5 text-text-primary">{realisticMonth12MRR.toLocaleString('vi-VN')} VNĐ</p>
                  <p className="text-[10px] text-text-secondary font-medium">Doanh thu đều đặn hàng tháng dự báo.</p>
                </div>

                <div className="bg-[#070b13]/85 p-4 rounded-xl border border-slate-900">
                  <span className="text-text-tertiary text-[10px] uppercase font-bold tracking-wider">Tổng Users Đạt Được</span>
                  <p className="text-xl font-black mt-1 mb-0.5 text-purple-400">{realisticCumulativeUsers.toLocaleString('vi-VN')} Khách</p>
                  <p className="text-[10px] text-text-secondary font-medium font-semibold">Tích lũy lũy kế sau 12 tháng hạch toán.</p>
                </div>

                <div className="bg-[#070b13]/85 p-4 rounded-xl border border-slate-900">
                  <span className="text-text-tertiary text-[10px] uppercase font-bold tracking-wider font-mono">Payback Period (SEO)</span>
                  <p className="text-xl font-black mt-1 mb-0.5 text-emerald-400">~ {estimatedPaybackWeeks} Tuần</p>
                  <p className="text-[10px] text-text-secondary font-medium">Thời gian hòa vốn chi phí phân hữu du kích.</p>
                </div>
              </div>
              ...
              <div className="bg-[#070b13]/85 p-5 rounded-2xl border border-slate-900 space-y-5">
                <div className="flex justify-between items-center border-b border-slate-900 pb-2">
                  <span className="text-[10px] text-text-tertiary font-black tracking-widest uppercase font-mono">📊 Phân tích 3 Kịch Bản Doanh Thu (Conservative vs Realistic vs Optimistic)</span>
                ...
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-900 text-xs italic leading-relaxed text-text-secondary font-semibold text-center font-mono">
