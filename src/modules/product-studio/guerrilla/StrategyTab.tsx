...
export default function StrategyTab({
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 font-sans">
            ...
            <div className="bg-slate-950/40 border border-slate-900 rounded-3xl p-5 space-y-4">
              <div className="flex items-center gap-2 border-b border-slate-900 pb-3">
                ...
                <div>
                  <h4 className="text-xs font-black uppercase text-slate-300">I. CON ĐƯỜNG TRUYỀN THỐNG (Khó sống sót)</h4>
                  <p className="text-[10px] text-slate-500 font-bold">Thường dẫn tới cạn vốn của 95% Solo Founder ít ngân sách</p>
                </div>
              </div>
              
              <div className="space-y-3.5 text-xs text-slate-400 font-semibold leading-relaxed">
                  ...
                  >
                    ...
                    <div className="mt-3 flex justify-center items-center gap-1">
                      {isSelected ? (
                        ...
                        <span className="text-[8px] font-black text-slate-500 group-hover:text-slate-300 transition-all">
                          XEM CHI TIẾT →
                        </span>
                      )}
                    </div>
                  ...
                  <div className="lg:col-span-6 bg-slate-950 p-5 rounded-2xl border border-slate-900 space-y-4 min-h-[300px]">
                    ...
                    <div className="space-y-2 bg-[#04080e]/60 p-3 rounded-xl border border-slate-900/65">
                      ...
                      <button
                        ...
                        className="w-full mt-1.5 py-2.5 text-[10px] font-black uppercase bg-slate-900 hover:bg-emerald-950/20 text-slate-350 hover:text-emerald-400 border border-slate-800 hover:border-emerald-500/30 rounded-lg transition-all flex items-center justify-center gap-1.5 shrink-0 select-none cursor-pointer"
                      >
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 pt-2 text-left">
            ...
            <div className="bg-slate-955 p-5 rounded-3xl border border-slate-900 space-y-4">
              ...
              <div className="space-y-4 text-xs text-slate-400 leading-relaxed font-semibold">
                <div className="space-y-1">
        ...
        <div className="space-y-6 text-left">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={widx} className="bg-slate-955 p-4 rounded-xl border border-slate-900 space-y-3 hover:border-slate-800 transition-all">
                <div className="flex justify-between items-start">
                  <span className="text-[9px] font-mono font-bold text-slate-500 bg-slate-950 px-2 py-0.5 rounded border border-slate-900">
                    {wp.role}
                  </span>
                ...
                <h4 className="text-xs font-black text-white">{wp.title}</h4>
                <p className="text-[10px] text-slate-400 font-semibold leading-relaxed">
                  {wp.desc}
                </p>
              </div>
          ...
          <div className="bg-slate-955 p-5 rounded-3xl border border-slate-900 space-y-4">
            ...
            <div className="space-y-4 text-xs font-semibold leading-relaxed">
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-slate-400">Không mở rộng tính năng theo thói quen ngẫu hứng. Mọi nỗ lực phải dồn vào việc đưa sản phẩm MVP thô ra thị trường đo lường phản hồi trong dưới 1 tuần.</p>
              </div>
              <div className="space-y-1">
                <span className="text-emerald-404 font-bold text-[11px] block">2. Ưu tiên offline-first tuyệt đối:</span>
                <p className="text-[10px] text-slate-400">Dùng SQLite cục bộ hoặc LocalStorage để người dùng lưu tiến trình. Cắt bỏ 100% database Cloud đắt tiền ở giai đoạn đầu để solo founder không lo gánh nợ VPS.</p>
              </div>
              <div className="space-y-1">
                <span className="text-emerald-404 font-bold text-[11px] block">3. Code review sạch rác:</span>
                <p className="text-[10px] text-slate-400">Tránh viết mã rườm rà. Lợi dụng AI dọn sạch các import lỗi thời, các console log rác trước khi compile đóng gói bundle nhằm tối ưu tối đa dung lượng tệp tải.</p>
              </div>
              <div className="space-y-1">
                <span className="text-emerald-404 font-bold text-[11px] block">4. Bảo mật JWT & Vault:</span>
                <p className="text-[10px] text-slate-400">Không bao giờ lưu cứng API key của OpenAI hay Gemini trong code client-side. Phải nạp qua Vault bảo mật an toàn ở backend để chống rò rỉ phá hoại hóa đơn.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-955 p-5 rounded-3xl border border-slate-900 space-y-4">
            ...
            <div className="space-y-4 text-xs font-semibold leading-relaxed">
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-slate-400">Xây dựng hàng tá tính năng phụ phức tạp mà thực tế 98% khách hàng không bao giờ bấm vào, dẫn tới trễ hạn ra mắt chợ hàng tháng trời.</p>
              </div>
              <div className="space-y-1">
                <span className="text-rose-455 font-bold text-[11px] block">2. Đốt tiền vào quảng cáo trả phí (Paid Ads):</span>
                <p className="text-[10px] text-slate-400">Chạy Ads Facebook khi sản phẩm chưa đạt độ tối ưu giữ chân (Retention Metric), khiến tiền quảng cáo thâm hụt ví rất nhanh.</p>
              </div>
              <div className="space-y-1">
                <span className="text-rose-455 font-bold text-[11px] block">3. Bỏ bê khâu kiểm thử (QA/QC):</span>
                <p className="text-[10px] text-slate-400">Deploy ứng dụng lỗi tràn lan khiến những người dùng đầu tiên giận dữ gỡ app và viết đánh giá 1 sao hủy diệt uy tín vĩnh viễn.</p>
              </div>
              <div className="space-y-1">
                <span className="text-rose-455 font-bold text-[11px] block">4. Thu phí thuê bao cứng nhắc (SaaS Trap):</span>
                <p className="text-[10px] text-slate-400">Bắt khách trả phí hàng tháng ngay lập tức ở Việt Nam. Hãy chuyển sang bán Lifetime Deal (mua đứt vĩnh viễn) cực rẻ ở giai đoạn đầu để gom khách nhanh.</p>
              </div>
              <div className="space-y-1">
                <span className="text-rose-455 font-bold text-[11px] block">5. Lười Reskin nhân bản:</span>
                <p className="text-[10px] text-slate-400">Không chịu reskin nhân bản codebase lõi ra nhiều ứng dụng ngách khác nhau. Đừng bỏ trứng vào duy nhất 1 giỏ ứng dụng mạo hiểm.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-950 p-6 rounded-3xl border border-slate-900 space-y-4">
            <div className="text-left font-sans">
              ...
              <p className="text-[11px] text-slate-400 font-semibold mt-1 leading-normal font-sans">
          ...
          <div className="bg-slate-950 p-6 rounded-3xl border border-slate-900 space-y-4 text-left">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3.5 pt-2">
              {[
                ...
                <div key={cidx} className={`p-4 rounded-2xl border ${comp.color} space-y-2 hover:border-slate-800 transition-all cursor-default`}>
                  <div className="space-y-0.5">
                    <span className="text-[8px] font-mono font-black uppercase opacity-60">VÒNG LẶP 0{cidx + 1}</span>
                    <h4 className="text-[11.5px] font-black text-white">{comp.step}</h4>
                  ...
                  <div className="pt-2 border-t border-slate-900 text-[9.5px] leading-normal font-bold">
                    <span className="text-slate-500 font-semibold block mb-0.5">⚡ Hành động:</span>
                    {comp.highlight}
                  </div>
                </div>
              ))}
          ...
          <div className="bg-slate-950 p-6 rounded-3xl border border-slate-900 space-y-4 text-left">
            ...
            <div className="overflow-x-auto border border-slate-900 rounded-2xl">
              <table className="w-full text-[11px] font-sans text-left border-collapse">
                <thead>
                  <tr className="bg-slate-900 border-b border-slate-850 text-slate-450 uppercase font-black tracking-wider text-[9px]/none">
                ...
                <tbody className="divide-y divide-slate-900/60 font-semibold text-slate-400">
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Hoạch định yêu cầu</td>
                  ...
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Quản lý Tiến độ</td>
                  ...
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Định vị thị trường</td>
                  ...
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Học tập kỹ thuật</td>
                  ...
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Quản trị Rủi ro</td>
                  ...
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Giám sát hiệu suất</td>
                  ...
                  <tr>
                    <td className="p-4 py-3 font-bold text-slate-300">Duy trì & Bàn giao</td>
      ...
      <div className="bg-gradient-to-r from-purple-950/15 via-[#060a12] to-emerald-950/15 border border-slate-800 p-5 rounded-3xl space-y-3.5 shadow-xl font-sans text-left">
        ...
        <div className="grid sm:grid-cols-3 gap-4 text-xs text-slate-400 leading-relaxed font-semibold">
