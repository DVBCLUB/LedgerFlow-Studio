          ...
          <div className="bg-slate-900/60 p-4 rounded-2xl border border-slate-850 space-y-2.5">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1 px-3 py-2 bg-slate-950 border border-slate-800 hover:bg-slate-900 text-[10px] font-black text-slate-350 hover:text-white rounded-xl transition-all cursor-pointer select-none"
              ...
              <label 
                className="flex-1 flex items-center justify-center gap-1 px-3 py-2 bg-slate-950 border border-slate-800 text-[10px] font-black text-slate-350 hover:text-white rounded-xl cursor-pointer transition-all hover:bg-slate-900 select-none"
        ...
        <div className="lg:col-span-7 bg-slate-950/60 border border-slate-900 rounded-3xl p-5 flex flex-col justify-between shadow-lg space-y-4 min-h-[500px]">
          {currentIdea ? (
            <div className="space-y-4 flex-1 flex flex-col justify-between">
                ...
                <div className="flex justify-between items-start gap-4 border-b border-slate-900 pb-3">
                  ...
                  <div className="flex gap-2 shrink-0">
                    <button
                      ...
                      disabled={loadingAI}
                      className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-black text-xs rounded-xl shadow shadow-emerald-500/15 disabled:bg-slate-800 disabled:from-slate-800 disabled:to-slate-800 flex items-center gap-1.5 transition-all select-none cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-500 hover:to-rose-500 text-white font-black text-xs rounded-xl shadow shadow-pink-500/15 flex items-center gap-1.5 transition-all select-none cursor-pointer"
                    >
              ...
              <div className="bg-slate-900/60 border border-slate-850 p-4 rounded-2xl space-y-3 shadow-xl text-left">
                      ...
                      >
                        <div className="flex items-start gap-2.5">
                          ...
                          <div className="space-y-0.5">
                            ...
                            <p className={`text-[10.5px] leading-relaxed font-medium ${isCompleted ? "line-through text-slate-500" : "text-slate-350"}`}>
                              {step.desc}
                            </p>
                          </div>
                        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full space-y-4 shadow-2xl animate-in fade-in zoom-in duration-200">
            <div className="flex items-center gap-2 border-b border-slate-800 pb-3">
              ...
              <h3 className="text-sm font-black text-white uppercase">Xác nhận Nhập Dữ Liệu</h3>
            </div>
            ...
            <div className="bg-slate-950 p-3 rounded-xl border border-slate-850 space-y-1.5 text-[10.5px] text-slate-400">
            ...
            <div className="flex flex-col sm:flex-row gap-2 pt-2">
              <button
                ...
                className="flex-1 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs shadow-md shadow-emerald-500/10 transition-all cursor-pointer"
              >
                Gộp dữ liệu (Merge)
              </button>
              <button
              ...
              <button
                ...
                className="px-4 py-2 bg-slate-800 hover:bg-slate-750 text-slate-400 rounded-xl text-xs font-bold transition-all cursor-pointer"
              >
                Hủy bỏ
              </button>
            </div>
