...
export default function CEOOverviewPanel() {
  ...
  return (
    <div className="space-y-6">
      <section className="ui-card-accent p-6">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-500 px-4 py-3 text-xs font-black text-slate-950 shadow-lg shadow-emerald-500/10 cursor-pointer"
          >
      ...
      <section className="grid gap-4 xl:grid-cols-3">
        ...
        <div className="ui-card border-amber-500/20 bg-amber-500/5 p-5">
      ...
      <section className="ui-card border-blue-500/20 bg-blue-500/5 p-5">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="ui-card p-5">
          ...
          <p className="fin-num mt-2 text-xl font-black text-white">{money(dashboard.remainingBudget)} đ</p>
        ...
        <div className="ui-card p-5">
          ...
          <p className="fin-num mt-2 text-xl font-black text-white">{dashboard.advanceRatio}%</p>
          <p className="fin-num mt-2 text-xs font-semibold leading-6 text-slate-400">
            Còn treo {money(dashboard.openAdvance)} đ cần bổ sung chứng từ.
          </p>
        </div>
        ...
        <div className="ui-card p-5">
          ...
          <p className="fin-num mt-2 text-xl font-black text-white">{dashboard.missingDocRatio}%</p>
        ...
        <div className="ui-card border-rose-500/20 bg-rose-500/5 p-5">
      ...
      <section className="grid gap-4 lg:grid-cols-5">
        <div className="ui-card lg:col-span-3 p-5">
          <h2 className="mb-4 flex items-center gap-2 text-sm font-black uppercase tracking-wider text-white">
            ...
            {COMMAND_CENTER_REPORT_TEMPLATES.map((template) => (
              <div key={template.title} className="rounded-xl border border-slate-800 bg-slate-950/70 p-4">
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center gap-2 rounded-lg border border-slate-700 px-3 py-2 text-[11px] font-black text-slate-300 hover:border-emerald-400 hover:text-white cursor-pointer"
                >
      ...
      <section className="ui-card border-emerald-500/20 bg-emerald-500/5 p-5">
