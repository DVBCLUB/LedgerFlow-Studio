    ...
    <section className="space-y-4 text-slate-100">
      <div className="rounded-3xl border border-emerald-500/25 bg-slate-950/80 p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-black text-text-primary">LedgerFlow Hub — màn hình bắt đầu</h2>
            ...
            <article key={path.title} className={`rounded-3xl border ${tone.border} ${tone.bg} p-5`}>
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-2 text-xs font-semibold leading-6 text-text-secondary">{path.note}</p>
                  <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-border-secondary bg-slate-950/70 px-3 py-1 text-[11px] font-black text-slate-200">
      ...
      <div className="rounded-3xl border border-border-primary bg-bg-surface/70 p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-black text-text-primary">Nguyên tắc dùng app hiện tại</h3>
            <p className="mt-2 text-sm font-semibold leading-7 text-text-secondary">
