        ...
        <div className="lg:col-span-7 bg-[#040812] border border-slate-900 rounded-2xl p-5 space-y-4">
          <div className="flex justify-between items-center border-b border-slate-850 pb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-text-primary font-black uppercase">Trình soạn thảo Python</span>
            </div>

            {/* Template Selector dropdown */}
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-text-tertiary uppercase font-mono">Chuyên đề:</span>
              <div className="flex gap-1 bg-slate-950 p-1 border border-slate-900 rounded-lg">
                <button
                  onClick={() => selectTemplate('benford')}
                  className="px-2.5 py-1 text-[10px] font-bold uppercase rounded hover:text-text-primary transition-all text-text-secondary cursor-pointer"
                >
                  Benford Law
                </button>
                <button
          ...
          <div className="flex justify-between items-center pt-1.5">
            <span className="text-[10px] text-text-tertiary font-medium italic flex items-center gap-1">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-orange-650 to-amber-600 hover:from-orange-550 hover:to-amber-500 text-text-primary font-extrabold rounded-xl uppercase tracking-wider flex items-center gap-2 shadow-lg cursor-pointer transition-all disabled:opacity-50"
            >
              {isRunning ? (
                <>
                ...
                <>
                  <Play className="w-4 h-4 text-text-primary fill-white" />
                  Xử Lý &amp; Chạy Python
                </>
              )}
            </button>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          <div className="bg-[#02050a] border border-slate-900 rounded-2xl p-5 flex-1 flex flex-col">
            <div className="flex justify-between items-center border-b border-slate-900 pb-2.5 mb-3 shrink-0">
              <span className="text-text-secondary font-black uppercase flex items-center gap-2">
                <Terminal className="w-4 h-4 text-text-secondary" />
                Kết quả chạy Python
              </span>
              <button 
                onClick={() => setStdout('>>> Sổ lệnh sạch sẽ...')}
                className="text-text-tertiary hover:text-slate-350 text-[10px] font-black uppercase cursor-pointer"
              >
                Xóa
              </button>
            </div>
          ...
          <div className="bg-[#040812] border border-slate-900 rounded-2xl p-5 h-[155px] shrink-0 flex flex-col">
            <span className="text-[10px] text-text-tertiary font-bold uppercase tracking-wider block border-b border-slate-900 pb-1.5 mb-2.5">
              Nhật ký hệ thống cục bộ
            </span>
            <div className="flex-1 overflow-y-auto font-mono text-[9.5px] leading-relaxed text-text-tertiary space-y-1.5 scrollbar-thin pr-1 select-text">
              {sysLogs.length === 0 ? (
