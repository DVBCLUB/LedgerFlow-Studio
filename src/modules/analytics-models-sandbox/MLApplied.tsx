...
export default function MLApplied() {
    ...
    <div className="space-y-6">
      ...
      <section className="bg-slate-950 border border-slate-850 p-6 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-text-primary">Machine Learning Ứng Dụng Thực Tế</h1>
        ...
        <div className="flex flex-wrap gap-1.5 p-1 bg-bg-primary border border-border-primary rounded-xl">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
              activeTab === 'layer1' ? 'bg-cyan-650 text-text-primary shadow' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
              activeTab === 'layer2' ? 'bg-cyan-650 text-text-primary shadow' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
              activeTab === 'layer3' ? 'bg-cyan-650 text-text-primary shadow' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
              activeTab === 'vision' ? 'bg-cyan-650 text-text-primary shadow' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-6">
            <div className="space-y-2">
              ...
              <h3 className="text-base font-black text-text-primary">Tầng 1 - Kính Phóng Đại Trợ Lý Qua API AI</h3>
  ...
  return JSON.parse(text);
          ...
          <div className="lg:col-span-5 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-5">
            <h3 className="text-base font-black text-text-primary flex items-center gap-1.5 leading-none">
            ...
            <div className="p-5 bg-slate-950 border border-slate-850 rounded-xl text-center space-y-4">
              <button
                ...
                className={`w-14 h-14 rounded-full flex items-center justify-center mx-auto border transition-all cursor-pointer ${
                  isListening 
                    ? 'bg-rose-600 border-rose-500 shadow-lg shadow-rose-500/20 text-text-primary animate-pulse' 
                    : 'bg-cyan-650 border-cyan-550 text-text-primary shadow-lg shadow-cyan-500/15 hover:bg-cyan-550'
                }`}
              >
              ...
              <div className="space-y-1.5">
                <span className="text-[10px] text-text-tertiary uppercase tracking-widest font-black block">Kết Quả Nhận Diện Giọng Nói</span>
            ...
            <div className="text-[10px] text-text-tertiary leading-normal font-semibold">
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-5">
            <div className="space-y-1.5">
              ...
              <h3 className="text-base font-black text-text-primary">Tầng 2 - Huấn Luyện Các Mô Hình Dự Báo Nhỏ &amp; Churn</h3>
              <p className="text-xs text-text-secondary leading-relaxed font-semibold">
    ...
    pickle.dump((vectorizer, clf), f)`, 'sklearn_code')}
          ...
          <div className="lg:col-span-5 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-5">
            ...
            <div className="p-3.5 bg-slate-950 border border-slate-850 rounded-xl space-y-2">
              <span className="text-[10px] text-text-tertiary uppercase font-black block">Mã nguồn chạy Dự báo (Facebook Prophet Pipeline)</span>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-5">
            <div className="space-y-1.5">
              ...
              <h3 className="text-base font-black text-text-primary">Tầng 3 - Cơ Chế Trí Tuệ Nhân Tạo Trong Game 2D/3D</h3>
              <p className="text-xs text-text-secondary leading-relaxed font-semibold">
    ...
    if (this.state === 'idle' && distanceToPlayer < 100) this.transition('chase');
          ...
          <div className="lg:col-span-5 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-4">
            ...
            <div className="bg-slate-950 p-4 border border-slate-850 rounded-xl space-y-3.5">
              ...
              <p className="text-[10.5px] text-text-secondary leading-normal italic font-semibold">{fsmTriggers[fsmState].desc}</p>

              {/* Grid drawing visual */}
              <div className="grid grid-cols-8 gap-1.5 bg-bg-primary p-2 border border-border-primary rounded-xl text-center">
                    ...
                    return (
                      <div 
                        ...
                        className={`h-7 rounded-sm flex items-center justify-center text-[9px] font-bold ${
                          isAgent 
                            ? 'bg-rose-500 text-text-primary shadow shadow-rose-500/30' 
                            : isTarget 
                            ? 'bg-sky-500 text-text-primary shadow shadow-sky-500/30 animate-pulse' 
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 bg-cyan-600 hover:bg-cyan-550 text-text-primary rounded-lg text-xs font-bold cursor-pointer font-sans shadow"
                >
                ...
                <button
                  ...
                  className="px-3 bg-bg-primary border border-border-primary hover:text-text-primary rounded-lg text-xs font-bold cursor-pointer"
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-6">
            <div className="space-y-1.5">
              ...
              <h3 className="text-base font-black text-text-primary">Tầng 2+3 - Computer Vision cho Game &amp; Ứng Dụng Kế Toán</h3>
              <p className="text-xs text-text-secondary leading-relaxed font-semibold">
...
async function performOfflineOCR(imageBlob) {
  ...
  return ret.data.text;
                  ...
                  className="text-cyan-405 font-bold hover:text-text-primary"
                >
...
{`async function performOfflineOCR(imageBlob) {
  ...
  return ret.data.text;
          ...
          <div className="lg:col-span-4 bg-slate-950/40 border border-slate-850 rounded-2xl p-6 shadow-xl space-y-4">
            ...
            <ul className="space-y-3 text-[11.5px] text-text-secondary font-bold pl-1">
              <li className="flex items-start gap-1.5">
                <span className="w-1.5 h-1.5 rounded bg-cyan-500 mt-1.5 shrink-0"></span>
                <span>Luôn khai báo quyền sử dụng Camera rõ ràng bảo mật trong file <strong className="text-text-secondary">metadata.json</strong> của workspace.</span>
              </li>
              <li className="flex items-start gap-1.5">
                <span className="w-1.5 h-1.5 rounded bg-cyan-500 mt-1.5 shrink-0"></span>
