      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-3 space-y-4">
          <div className="bg-slate-950 p-2.5 rounded-2xl border border-slate-900">
            <span className="text-[10px] text-text-tertiary font-extrabold uppercase tracking-widest pl-2.5 block mb-2 font-mono">FINDS MODULES</span>
              ...
              {([
                ...
                <button
                  ...
                  className={`p-3 rounded-xl border text-left transition-all flex items-center justify-between group ${
                    findsSubTab === item.id
                      ? 'bg-indigo-600/15 border-indigo-500/50 text-text-primary'
                      : 'bg-transparent border-transparent hover:bg-bg-primary/60 text-text-secondary hover:text-slate-200'
                  }`}
                >
                  <div>
                    <span className="text-[11.5px] font-black block">{item.label}</span>
                    <span className="text-[9px] text-text-tertiary font-bold font-mono block mt-0.5">{item.desc}</span>
                  </div>
          ...
          <div className="p-4 bg-slate-950 rounded-xl border border-slate-900 space-y-3">
            ...
            {FINANCIAL_MODELER_SCENARIOS.map((scenario) => (
              <article key={scenario.id} className="rounded-xl border border-border-primary bg-bg-surface/70 p-3">
                <p className="text-[11px] font-black text-text-primary">{scenario.title}</p>
                <p className="mt-1 text-[10px] font-semibold leading-4 text-text-secondary">Driver: {scenario.driver}</p>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-slate-900 pb-3">
                <div>
                  ...
                  <p className="text-xs text-text-tertiary font-semibold mt-0.5">Dự tính toán học giá trị dài hạn bình quân trên mỗi chi phí thu hộ</p>
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 bg-slate-950 p-4 rounded-xl border border-slate-900">
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px]">
                    <span className="text-text-secondary font-bold">Biên doanh thu ARPU (tháng):</span>
                    <strong className="text-text-primary font-mono">{arpu.toLocaleString('vi-VN')} VND</strong>
                  </div>
                  <input
                    type="range"
                    min="100000"
                    ...
                    className="w-full h-1 bg-bg-surface rounded-lg appearance-none cursor-pointer accent-indigo-500"
                  />
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px]">
                    <span className="text-text-secondary font-bold">Tỷ lệ rời bỏ (MoM Churn):</span>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px]">
                    <span className="text-text-secondary font-bold">Chi phí tìm khách (CAC):</span>
                    <strong className="text-text-primary font-mono">{cac.toLocaleString('vi-VN')} VND</strong>
                  </div>
                  <input
                    type="range"
                    min="200000"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-[#050a14] border border-slate-900 p-3 rounded-xl flex flex-col justify-between">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Lifespan Kỳ Vọng</span>
                ...
                <div className="bg-[#050a14] border border-slate-900 p-3 rounded-xl flex flex-col justify-between">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Lifetime Value (LTV)</span>
                ...
                <div className="bg-[#050a14] border border-slate-900 p-3 rounded-xl flex flex-col justify-between">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Tỷ số LTV / CAC</span>
                ...
                <div className="bg-[#050a14] border border-slate-900 p-3 rounded-xl flex flex-col justify-between">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Kết luận Tài chính</span>
              ...
              <div className="p-4 bg-slate-950 border border-slate-900 rounded-xl space-y-3">
                <span className="text-[10px] font-bold text-text-secondary uppercase tracking-widest font-mono block">
                ...
                <p className="text-[10px] text-text-tertiary text-center italic font-semibold">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-900">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[10.5px] font-bold text-text-secondary font-mono">pandas_survival_model.py</span>
                    <button
                      onClick={() => copyToClipboard(pythonSnippets.ltv_cac, 'ltv_cac')}
                      className="px-2 py-0.5 rounded bg-bg-primary text-text-secondary hover:text-text-primary border border-border-primary text-[9px] transition-all"
                    >
                      {copiedId === 'ltv_cac' ? 'Đã copy' : 'Copy Code'}
                    </button>
                  </div>
                  <pre className="p-4 bg-slate-950 border border-slate-900 rounded-xl overflow-x-auto font-mono text-[11px] text-text-secondary leading-relaxed font-semibold">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-slate-900 pb-3">
                <div>
                  ...
                  <p className="text-xs text-text-tertiary font-semibold mt-0.5">Xác định tỷ suất lợi nhuận kỳ vọng của tài sản dựa vào rủi ro hệ thống của thị trường</p>
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 bg-slate-950 p-4 rounded-xl border border-slate-900">
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px]">
                    <span className="text-text-secondary font-bold">Lợi suất phi rủi ro (Risk-Free):</span>
                    <strong className="text-text-primary font-mono">{riskFreeRate}%</strong>
                  </div>
                  <input
                    type="range"
                    min="2"
                    ...
                    className="w-full h-1 bg-bg-surface rounded-lg appearance-none cursor-pointer accent-emerald-500"
                  />
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px]">
                    <span className="text-text-secondary font-bold">Hệ số nhạy rủi ro Beta (β):</span>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px]">
                    <span className="text-text-secondary font-bold">Lợi suất sàn thị trường (Rm):</span>
                    <strong className="text-text-primary font-mono">{marketRate}%</strong>
                  </div>
                  <input
                    type="range"
                    min="6"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-[#050a0a] border border-slate-900 p-3 rounded-xl">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Lợi nhuận kỳ vọng CAPM</span>
                ...
                <div className="bg-[#050a0a] border border-slate-900 p-3 rounded-xl">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Bù đắp rủi ro (Premium)</span>
                  <strong className="text-xs text-text-secondary mt-2 font-mono block font-black">{(marketRate - riskFreeRate).toFixed(2)}%</strong>
                  <span className="text-[8.5px] text-slate-600 block mt-1">(Rm - Rf)</span>
                </div>

                <div className="bg-[#050a0a] border border-slate-900 p-3 rounded-xl">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Tính chất biến động</span>
                  <strong className="text-xs text-text-secondary mt-2 block font-extrabold whitespace-nowrap">
                ...
                <div className="bg-[#050a0a] border border-slate-900 p-3 rounded-xl">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Ứng dụng Khoa học Số</span>
              ...
              <div className="p-4 bg-slate-950 border border-slate-900 rounded-xl space-y-3">
                ...
                <div className="text-[10.5px] text-text-secondary bg-bg-primary/40 p-3 rounded-lg leading-relaxed font-semibold">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-900">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[10.5px] font-bold text-text-secondary font-mono">ols_beta_regression.py</span>
                    <button
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-slate-900 pb-3">
                <div>
                  ...
                  <p className="text-xs text-text-tertiary font-semibold mt-0.5">Thực thi hàng trăm kịch bản thị trường biến đổi bất định để tính toán Net Present Value (NPV)</p>
                </div>
              ...
              <div className="grid md:grid-cols-5 gap-4 bg-slate-950 p-4 rounded-xl border border-slate-900">
                <div className="space-y-1 md:col-span-1">
                  <span className="text-[10px] text-text-secondary font-bold block">Đầu tư (Y0):</span>
                  <strong className="text-xs font-mono text-text-primary block mt-0.5">{mcInvestment}M VND</strong>
                  <input
                    type="range"
                    min="50"
                    max="1000"
                ...
                <div className="space-y-1 md:col-span-1">
                  <span className="text-[10px] text-text-secondary font-bold block">Tiền thu / Năm:</span>
                  <strong className="text-xs font-mono text-text-primary block mt-0.5">{mcCashFlow}M VND</strong>
                  <input
                    type="range"
                    min="30"
                    max="400"
                ...
                <div className="space-y-1 md:col-span-1">
                  <span className="text-[10px] text-text-secondary font-bold block">Độ lệch biên SD (%):</span>
                ...
                <div className="space-y-1 md:col-span-1">
                  <span className="text-[10px] text-text-secondary font-bold block">Lợi suất đòi hỏi (WACC):</span>
                  <strong className="text-xs font-mono text-text-primary block mt-0.5">{mcDiscount}%</strong>
                  <input
                    type="range"
                    min="4"
                    max="20"
                ...
                <div className="space-y-1 md:col-span-1">
                  <span className="text-[10px] text-text-secondary font-bold block">Thời gian thẩm định:</span>
                  <strong className="text-xs font-mono text-text-primary block mt-0.5">{mcYears} Năm</strong>
                  <input
                    type="range"
                    min="3"
                    max="10"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-[#0a050a] border border-slate-900 p-3 rounded-xl">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">NPV Trung bình Simulated</span>
                  <strong className={`text-xs mt-2 font-mono block font-black ${
                ...
                <div className="bg-[#0a050a] border border-slate-900 p-3 rounded-xl">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Xác suất thành công</span>
                ...
                <div className="bg-[#0a050a] border border-slate-900 p-3 rounded-xl col-span-2">
                  <span className="text-[9px] text-text-tertiary font-extrabold uppercase">Giá trị NPV theo 5 kịch bản thị trường khác nhau:</span>
              ...
              <div className="p-4 bg-slate-950 border border-slate-900 rounded-xl space-y-3">
                ...
                <div className="text-[10px] text-text-tertiary flex gap-4 justify-center font-bold">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-900">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[10.5px] font-bold text-text-secondary font-mono">numpy_monte_carlo.py</span>
                    <button
