...
export default function VideoMakerPanel() {
  ...
  return (
    <div className="space-y-6 text-left">
      {/* Header */}
      <div className="rounded-[2rem] border border-border-primary bg-slate-950/55 p-6 text-slate-100">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h1 className="mt-2 text-2xl font-bold text-text-primary">AI Video Creator Studio</h1>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="space-y-6">
          ...
          {/* Form */}
          <form onSubmit={handleGenerate} className="rounded-3xl border border-border-primary bg-bg-primary/40 p-5 space-y-4">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-violet-600 px-4 py-3 text-xs font-black uppercase text-text-primary hover:bg-violet-500 active:scale-95 disabled:opacity-40 transition-all"
            >
