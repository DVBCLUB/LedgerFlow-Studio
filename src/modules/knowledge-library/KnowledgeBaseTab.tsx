...
import { appendAgentOpsAudit, appendLocalStorageArrayItem, readLocalStorageValue, useLocalStorageVersion, writeLocalStorageValue } from '../ai-hr/storage';
...
export default function KnowledgeBaseTab() {
  ...
  const [subTab, setSubTab] = useState<'library' | 'rag_simulator'>('library');
