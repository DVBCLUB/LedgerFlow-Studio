      ...
      <section className="grid gap-5 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 space-y-5">
          <div className="rounded-3xl border border-indigo-400/30 bg-indigo-400/10 p-5">
            ...
            <pre className="mt-4 max-h-[260px] overflow-auto whitespace-pre-wrap rounded-2xl border border-slate-800 bg-slate-950 p-4 text-xs font-semibold leading-6 text-slate-300">
              {prompt}
            </pre>
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-700 px-4 py-2 text-xs font-black text-slate-200 hover:border-indigo-300/60 hover:text-indigo-200"
              >
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-950/70 p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-500">Generated draft</p>
                <h3 className="mt-1 text-lg font-black text-white">Bản nháp cần duyệt</h3>
              </div>
              <button
                type="button"
                onClick={() => navigator.clipboard?.writeText(aiDraft)}
                disabled={!aiDraft}
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-700 px-4 py-2 text-xs font-black text-slate-200 hover:border-indigo-300/60 hover:text-indigo-200 disabled:opacity-40"
              >
                <Copy className="h-4 w-4" /> Copy draft
              </button>
            </div>
            <pre className="mt-4 min-h-[220px] whitespace-pre-wrap rounded-2xl border border-slate-800 bg-slate-950 p-4 text-sm font-semibold leading-7 text-slate-300">
