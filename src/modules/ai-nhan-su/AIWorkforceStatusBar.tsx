...
export default function AIWorkforceStatusBar() {
  ...
  const statusColor = connected
    ...
    : 'from-slate-900/60 to-slate-900/60 border-border-primary';
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-semibold text-text-tertiary">agents chạy</span>
        </div>
        ...
        {activeSwarms > 0 && (
          <>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold text-text-tertiary">swarm ngầm</span>
            </div>
          </>
        )}
        ...
        {activeLoops > 0 && (
          <>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold text-text-tertiary">loop tự trị</span>
            </div>
          </>
        )}
        ...
        {(snapshot?.pendingApprovals ?? 0) > 0 && (
          <>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold text-text-tertiary">chờ duyệt</span>
            </div>
          </>
        )}
        ...
        {(snapshot?.blockedCount ?? 0) > 0 && (
          <>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold text-text-tertiary">bị block</span>
            </div>
          </>
        )}
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <button
          type="button"
          onClick={refresh}
          className="flex h-6 w-6 items-center justify-center rounded-lg border border-border-secondary bg-bg-primary/60 text-text-secondary transition hover:border-cyan-500/40 hover:text-cyan-300"
