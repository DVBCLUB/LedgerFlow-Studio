...
const inputClass = 'w-full rounded-2xl border border-border-primary bg-slate-950 px-3 py-2 text-xs font-bold text-text-primary outline-none transition placeholder:text-slate-600 focus:border-emerald-500/60';
  ...
  return (
    <section className={panelClass}>
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h2 className="text-base font-black text-text-primary">Mission Release Gate</h2>
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-4">
        <div className="rounded-2xl border border-border-primary bg-bg-surface/70 p-4"><p className="text-[10px] font-black uppercase tracking-[0.16em] text-emerald-300">Queue</p><p className="mt-2 truncate text-xs font-black text-text-primary">{queue?.id || 'No queue yet'}</p></div>
        <div className="rounded-2xl border border-border-primary bg-bg-surface/70 p-4"><p className="text-[10px] font-black uppercase tracking-[0.16em] text-emerald-300">Decision</p><p className="mt-2 text-xl font-black text-text-primary">{gate?.decision || '—'}</p></div>
        <div className="rounded-2xl border border-border-primary bg-bg-surface/70 p-4"><p className="text-[10px] font-black uppercase tracking-[0.16em] text-emerald-300">Score</p><p className="mt-2 text-xl font-black text-text-primary">{gate?.score ?? '—'}</p></div>
        <div className="rounded-2xl border border-border-primary bg-bg-surface/70 p-4"><p className="text-[10px] font-black uppercase tracking-[0.16em] text-emerald-300">Ready</p><p className="mt-2 text-xl font-black text-text-primary">{String(Boolean(gate?.releaseReady))}</p></div>
      </div>
